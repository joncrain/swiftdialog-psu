...
scriptLog="${4:-"/var/log/org.company.log"}"                        # Parameter 4: Script Log Location [ /var/log/org.company.log ] (i.e., Your organization's default location for client-side logs)
...
buildingsListRaw="Library, Office Building, Science Building, English Building, Student Center"
...
supportTeamPhone="+1 (555) 555-1212"
...
overlayicon="/Library/CPE/imgs/unity-box.png"
